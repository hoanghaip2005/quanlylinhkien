    ...
    <section class="hero-section bg-primary text-white py-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <img src="${pageContext.request.contextPath}/images/hero-motorcycle.jpg" 
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card category-card h-100">
                        <img src="${pageContext.request.contextPath}/images/lop-xe.jpg" 
                ...
                <div class="col-md-4 mb-4">
                    <div class="card category-card h-100">
                        <img src="${pageContext.request.contextPath}/images/phanh.jpg" 
                ...
                <div class="col-md-4 mb-4">
                    <div class="card category-card h-100">
                        <img src="${pageContext.request.contextPath}/images/nhot.jpg" 
        ...
        function createProductCard(product) {
            ...
            colDiv.innerHTML = `
                <div class="card product-card h-100">
                    <img src="${pageContext.request.contextPath}/images/\${product.image || 'default-product.jpg'}" 
